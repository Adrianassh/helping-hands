...
import com.helping.hands.bk.models.service.IUploadFileService;
import com.helping.hands.bk.util.paginator.PageRender;
...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		model.addAttribute("titulo", "List of requests");
